...
} USB_AUDIO_MIDI_EVENT_PACKET_3, *P_USB_AUDIO_MIDI_EVENT_PACKET_3;
...
typedef union
{
    union
    {
        ...
        struct
        {
            ...
            uint8_t DATA_1;
            uint8_t DATA_2;
            uint8_t CodeIndexNumber_2 :4;
            uint8_t CableNumber_2     :4;
            uint8_t DATA_3;
            uint8_t DATA_4;
            uint8_t DATA_5;
        };
    };
} USB_AUDIO_MIDI_EVENT_PACKET_2, *P_USB_AUDIO_MIDI_EVENT_PACKET_2;
